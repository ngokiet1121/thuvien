...
<div id="content_ad">
		<!-- PHAN BEN TRAI WEB -->
		<?php include_once "../admin-layout/left_category.php" ?>
		<div class="right_ad">
			...
			<div class="content-admin-pblsh">
				...
				<table>
					...
					<tr>
						<td>
							<input type="text" class="long-text" name="name" placeholder="Nhập tên thể loại" 
							value="<?php echo $name; ?>"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td>
						<input type="submit" class="submit_addnew" name="addnew" value="Chỉnh sửa"/>
						</td>
					</tr>
					<tr>
						<td>
