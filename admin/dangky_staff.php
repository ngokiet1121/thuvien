...
if (isset($_POST ["dang_ky"])){
	...
	if($email && $password && $phone)
	{
		...
		if ($num == 0)
		{
			...
			$query	=  "INSERT INTO tbl_user(f_name, l_name, address, phone, email, password, b_day, b_month, b_year, gender, photo,status,type)
						VALUES('$f_name','$l_name','$address','$phone','$email','$password','$b_day','$b_month','$b_year','$gender','$photo','$status','$type')";
...
<div id="container">
	...
	<div id="content">
		<!-- PHAN BEN TRAI WEB-->
		<?php include_once "left_home.php";?>
		<!-- PHAN CHINH GIUA WEB -->
		<div class="center">
			<!-- PHAN NOI DUNG CHINH -->
		<div class="menu-right">
					<div class="header-menu-right">
						<span>Đăng ký staff</span>
					</div>
					<div class="content-menu-right">
					<form action="dangky_staff.php" method="post">
						<table>
							<tr>
